                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header">
                                ...
                                @if($user->create)
                                    <button type="button" class="btn-action pull-right btn btn-success btn-sm" data-title="Tambah" data-action="create" data-options="?id={{ $data->id ?? '' }}" data-url="{!! $page->url ?? '' !!}">
